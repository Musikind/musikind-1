...
We believe music has the power to lift moods and provide harmony for those who need care. Musikind is an App that allows care homes around the UK to listen to their favourite songs and change moods.  
...
![start app thumbnails](https://ionicframework.com/docs/assets/img/installation/start-app-thumbnails.png)
